...
func (stub telemetryRepositoryStub) IngestSample(ctx context.Context, params telemetry.CreateSampleParams) (telemetry.IngestResult, error) {
	return telemetry.IngestResult{}, nil
}
